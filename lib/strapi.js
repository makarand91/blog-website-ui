...
export async function fetchBrands() {
  try {
    const response = await strapiClient.get('/brands?populate[articles][populate]=thumbnail')
...
export async function fetchArticleBySlug(slug) {
  try {
    const brandsResponse = await strapiClient.get('/brands?populate[articles][populate]=thumbnail')
